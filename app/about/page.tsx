...
export default function About() {
  return (
    <div>
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-[#0A1E3D] via-[#1a3a5f] to-[#0A1E3D] text-white py-20 md:py-32">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
              Empowering Financial Independence through <span className="text-[#F8B400]">Knowledge</span>
            </h1>
            <p className="text-lg md:text-xl text-gray-300 max-w-3xl mx-auto">
              At Market Dojo, we believe that everyone deserves the opportunity to achieve financial freedom through smart trading and investing.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-[#0A1E3D] mb-6">
                Our Story
              </h2>
            ...
            <div className="relative">
              ...
              />
              <div className="absolute -bottom-6 -left-6 bg-[#F8B400] text-[#0A1E3D] p-6 rounded-lg shadow-xl">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-2xl transition-all duration-300">
              <div className="bg-[#F8B400] w-16 h-16 rounded-full flex items-center justify-center mb-6">
              ...
              <h3 className="text-2xl font-bold text-[#0A1E3D] mb-4">Our Mission</h3>
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-2xl transition-all duration-300">
              ...
              <h3 className="text-2xl font-bold text-[#0A1E3D] mb-4">Our Vision</h3>
              <p className="text-gray-700 leading-relaxed">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div className="text-center p-6">
              <div className="bg-[#F8B400] w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-4">
                <svg className="w-6 h-6 text-[#0A1E3D]" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M6.267 3.455a3.066 3.066 0 001.745-.723 3.066 3.066 0 013.976 0 3.066 3.066 0 001.745.723 3.066 3.066 0 012.812 2.812c.051.643.304 1.254.723 1.745a3.066 3.066 0 010 3.976 3.066 3.066 0 00-.723 1.745 3.066 3.066 0 01-2.812 2.812 3.066 3.066 0 00-1.745.723 3.066 3.066 0 01-3.976 0 3.066 3.066 0 00-1.745-.723 3.066 3.066 0 01-2.812-2.812 3.066 3.066 0 00-.723-1.745 3.066 3.066 0 010-3.976 3.066 3.066 0 00.723-1.745 3.066 3.066 0 012.812-2.812zm7.44 5.252a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd"/>
                </svg>
              </div>
              <h4 className="font-bold text-[#0A1E3D] mb-2">Integrity</h4>
            ...
            <div className="text-center p-6">
              ...
              <h4 className="font-bold text-[#0A1E3D] mb-2">Excellence</h4>
            ...
            <div className="text-center p-6">
              ...
              <h4 className="font-bold text-[#0A1E3D] mb-2">Community</h4>
            ...
            <div className="text-center p-6">
              ...
              <h4 className="font-bold text-[#0A1E3D] mb-2">Innovation</h4>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
              ...
              <div className="p-6 text-center">
                <h3 className="text-xl font-bold text-[#0A1E3D] mb-2">Vikram Sharma</h3>
                <p className="text-[#F8B400] font-semibold mb-3">Chief Trading Strategist</p>
                ...
                <div className="flex justify-center space-x-3">
                  <a href="#" className="text-gray-400 hover:text-[#F8B400] transition-colors">
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
              ...
              />
              <div className="p-6 text-center">
                <h3 className="text-xl font-bold text-[#0A1E3D] mb-2">Priya Menon</h3>
                <p className="text-[#F8B400] font-semibold mb-3">Options Trading Expert</p>
                <p className="text-gray-600 text-sm mb-4">
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
              ...
              />
              <div className="p-6 text-center">
                <h3 className="text-xl font-bold text-[#0A1E3D] mb-2">Arjun Kapoor</h3>
                <p className="text-[#F8B400] font-semibold mb-3">Risk Management Specialist</p>
                <p className="text-gray-600 text-sm mb-4">
