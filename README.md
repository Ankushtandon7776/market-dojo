...
- **Interactive Components**: Dynamic navigation, forms, and hover effects
...
- **Primary Color**: Navy Blue (#0A1E3D)
- **Accent Color**: Gold (#F8B400)
...
- **Home (/)**: Hero, features, courses, testimonials
- **About (/about)**: Story, mission, vision, team
- **Courses (/courses)**: 9 courses with filters
