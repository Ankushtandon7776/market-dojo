...
export default function Footer() {
  return (
    <footer className="bg-navy text-white py-12 border-t border-navy-light">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex space-x-4">
              <a 
                ...
                className="bg-navy-light p-2 rounded-full hover:bg-gold hover:text-navy transition-all"
          ...
          {/* Contact Info */}
          <div>
            <h3 className="text-gold font-semibold text-lg mb-4">Contact</h3>
        ...
        {/* Bottom Bar */}
        <div className="border-t border-navy-light pt-8 flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
